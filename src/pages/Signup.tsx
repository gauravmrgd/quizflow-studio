...
const Signup = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center gradient-hero p-4 relative overflow-hidden">
      ...
      {/* Decorative rings */}
      <div className="absolute top-1/4 right-12 h-40 w-40 rounded-full border border-primary-foreground/5 animate-spin-slow" />
      <div className="absolute bottom-1/3 left-16 h-32 w-32 rounded-full border border-accent/10 animate-spin-slow" style={{ animationDirection: 'reverse' }} />
      {/* Radial spotlight */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_40%,hsl(185_72%_45%/0.1),transparent)]" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative mt-1">
              ...
              <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="John Doe" className="pl-10 rounded-xl border-primary-foreground/20 bg-primary-foreground/5 text-primary-foreground placeholder:text-primary-foreground/30 focus-visible:ring-accent transition-all" />
            </div>
          </div>
          <div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button type="submit" className="w-full gradient-accent text-accent-foreground rounded-xl py-6 text-base font-semibold shadow-glow-accent">Create account</Button>
          </motion.div>
        </form>
