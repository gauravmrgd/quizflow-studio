  ...
  return (
    <div className="flex min-h-screen items-center justify-center gradient-hero p-4 relative overflow-hidden">
      ...
      >
        ...
        {error && (
          <div className="mb-4 rounded-xl bg-destructive/20 p-3 text-sm text-destructive">{error}</div>
        )}
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full gradient-accent text-accent-foreground rounded-xl py-6 text-base font-semibold hover:scale-[1.02] transition-transform">Log in</Button>
        </form>
